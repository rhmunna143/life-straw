...
const InvestSection = () => {
    return (
        <div className="pb-32 px-4 flex gap-8 items-center">
            ...
            <div className="right">
                <h3 style={{lineHeight: "1.2"}} className="text-3xl md:text-5xl font-thin uppercase">Invest once, <span className="bg-primaryBg px-3 py-0.5 rounded-[33px]">enjoy</span> <br /> clean water for <span style={{ border: "1px solid black" }} className="px-3 py-0.5 rounded-[33px]">years</span></h3>
            </div>
        </div>
    );
};
